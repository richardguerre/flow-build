...
`}}}();r.hash="d797a1ad478fef6dfddf23a01caab468";const u=r,P=()=>{const{queryRef:n}=g(u,{},{fetchPolicy:"store-and-network"});return n?e(h,{queryRef:n}):null},h=n=>{const l=o.usePreloadedQuery(u,n.queryRef);return a("div",{className:"flex w-full",children:[a("div",{className:"bg-background-50 w-63 z-10 flex flex-shrink-0 flex-col gap-4 p-4 shadow-xl",children:[e("div",{className:"text-base font-semibold",children:"Settings"}),a("div",{className:"flex flex-col gap-2",children:[e(t,{to:"/settings/general",children:"General"}),e(t,{to:"/settings/tasks",children:"Tasks"}),e(t,{to:"/settings/routines",children:"Routines"}),e(t,{to:"/settings/browse-plugins",children:"Browse plugins"})]}),a("div",{className:"flex flex-col gap-2",children:[e("div",{className:"text-base font-semibold",children:"Plugin settings"}),l.installedPlugins.map(i=>e(b,{slug:i.slug},i.slug))]})]}),e(y,{context:l})]})},t=n=>{const l=d(n.to);return e(m,{to:n.to,className:c("text-foreground-700 hover:bg-background-200 rounded-md bg-transparent p-2",l&&"bg-primary-100 text-primary-600 hover:bg-primary-100"),children:n.children})},b=n=>{const[l,i]=f(async()=>p({pluginSlug:n.slug})),s=`settings/plugin/${n.slug}`;return i?e(t,{to:s,children:n.slug}):l?"_error"in l?(console.log("SettingViewPluginTab error",l),null):e(t,{to:s,children:l.name}):null};export{P as default};
