...
`}}}();K.hash="df29f91c0b0a28d479f55a924d0a59da";const h=()=>{C(K)},I=D,x=()=>{const n=o.useRef(p().startOf("day").add(4,"hours")),{queryRef:a,loadQuery:s}=L(I,{daysAfter:n.current.subtract(7,"day").format("YYYY-MM-DD"),firstDays:17,dayIdInFocus:`Day_${n.current.format("YYYY-MM-DD")}`});return o.useEffect(()=>{const l=setInterval(()=>{n.current=p().startOf("day"),s({daysAfter:n.current.subtract(7,"day").format("YYYY-MM-DD"),firstDays:17,dayIdInFocus:`Day_${n.current.format("YYYY-MM-DD")}`},{fetchPolicy:"store-and-network"})},36e5);return()=>clearInterval(l)},[]),a?g(R,{queryRef:a}):null},R=n=>{const a=T.usePreloadedQuery(I,n.queryRef);return h(),v("div",{className:"flex h-screen w-[calc(100%-60px)]",children:[g(A,{data:a}),g(b,{data:a})]})};export{x as default};
